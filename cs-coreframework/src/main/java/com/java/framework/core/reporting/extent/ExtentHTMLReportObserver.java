package com.java.framework.core.reporting.extent;
...
public class ExtentHTMLReportObserver implements HTMLReportObserver {
    ...
    public synchronized void setUp() {
        ...
        ExtentSparkReporter htmlReporter = new ExtentSparkReporter(new File(OUTPUT_DIRECTORY + currentDateTime+File.separator+ HTML_REPORT_NAME));
    ...
    public void setUp(String reportName) {
        String currentDateTime = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy_MM_dd HH_mm"));
        ExtentSparkReporter htmlReporter = new ExtentSparkReporter(OUTPUT_DIRECTORY + reportName + currentDateTime+File.separator + HTML_REPORT_NAME);
        configureExtentReportFromXml(htmlReporter);
        extentReports.attachReporter(htmlReporter);
    }
    ...
    public void createNode(String step) {
        extentTestNodeLocal = getTest().createNode(step);
    }
