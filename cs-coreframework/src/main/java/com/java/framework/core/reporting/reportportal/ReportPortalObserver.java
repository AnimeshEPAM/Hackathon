package com.java.framework.core.reporting.reportportal;
...
import com.java.framework.core.reporting.reportportal.api.requests.StartLaunchRequest;
import com.java.framework.core.reporting.reportportal.api.requests.StartSuiteRequest;
...
import com.java.framework.core.reporting.reportportal.api.builder.StartLaunchRequestBuilder;
import com.java.framework.core.reporting.reportportal.api.requests.FinishLaunchRequest;
import com.java.framework.core.reporting.reportportal.api.requests.FinishLaunchRequest.statusEnum;
import com.java.framework.core.reporting.reportportal.api.requests.FinishStepContainerRequest;
import com.java.framework.core.reporting.reportportal.api.requests.FinishStepRequest;
import com.java.framework.core.reporting.reportportal.api.requests.FinishSuiteRequest;
import com.java.framework.core.reporting.reportportal.api.requests.Issue;
import com.java.framework.core.reporting.reportportal.api.requests.Issue.issueType;
import com.java.framework.core.reporting.reportportal.api.requests.StartStepContainerRequest;
import com.java.framework.core.reporting.reportportal.api.requests.StartStepRequest;
import com.java.framework.core.reporting.reportportal.api.response.StartLaunchResponse;
import com.java.framework.core.reporting.reportportal.api.response.StartStepContainerResponse;
import com.java.framework.core.reporting.reportportal.api.response.StartStepResponse;
import com.java.framework.core.reporting.reportportal.api.response.StartSuiteResponse;
import com.java.framework.core.reporting.reportportal.api.utils.RequestHelper;
import com.java.framework.core.reporting.reportportal.api.utils.ResponseHelper;

import static com.java.framework.api.httpclient.HttpMethod.POST;
import static com.java.framework.api.httpclient.HttpMethod.PUT;
...
public class ReportPortalObserver implements HTMLReportObserver {
	...
	@Override
	public void createNode(String testStep) {
	...
	public void fail(String message) {
		...
		triggerReportPortalRequests(message,"failed");
	}
	...
	public void fail(String message, Throwable throwable) {
		...
		addScreenshot("Failure", message);
		triggerReportPortalRequests(message+"/n"+throwable.getMessage(),"failed");
	}
	...
	public void addScreenshot(String screenshotName, String description) {
		...
		File destFilePath = new File(OUTPUT_DIRECTORY + "/screenshots/");
	...
	public synchronized void addFile(String FileName, String description, String FileData) {
		...
		try {
			File destFile = new File(OUTPUT_DIRECTORY + "/screenshots/" + newFileName);
	...
	private void startSuiteRequest(String message) {
		...
		startSuiteRequest.setType(StartSuiteRequest.TestItem.TEST);
