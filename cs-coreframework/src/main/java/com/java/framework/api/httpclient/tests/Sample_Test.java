package com.java.framework.api.httpclient.tests;

import com.java.framework.api.httpclient.RestAPIResponseValidator;
...
import static com.java.framework.api.httpclient.HttpMethod.GET;
