package com.java.framework.api.httpclient;
...
public class RestAPIResponseValidator {
    ...
    public static boolean validateURI(String uri) throws HttpException, URISyntaxException {
        String url = RestAPIRequest.getHttpUriRequest().getURI().toString();
        if (url.equals(uri))
            return true;
        else {
            testContext.getLogger().log(LogLevel.ERROR, "Expected :" + url + "  found :" + uri);
            return false;
        }
    }
    ...
    public static boolean validateStatusCode(int expectedStatusCode) {
        ...
        if (actualStatusCode == expectedStatusCode)
            ...
            testContext.getLogger().log(LogLevel.ERROR, "Expected :" + expectedStatusCode + "  found :" + actualStatusCode);
            return false;
        }
    }
