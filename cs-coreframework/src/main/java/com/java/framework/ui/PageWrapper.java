...
import com.java.framework.core.constants.LoggerConstants;
...
import com.java.framework.ui.exceptions.IncorrectFormattersException;
...
public abstract class PageWrapper extends Browser{
    ...
    private String errorMessage = "Element to %S  is not found";
    ...
    public void click(String elementLocator, String elementName, String... formatters) {
        if (getElement(formatLocator(elementLocator, formatters)) != null) {
            ...
            Reporter.addScreenshot("Element Not Clicked","Not Clicked");
            testContext.getLogger().log(LogLevel.ERROR, String.format(errorMessage,"click"));
        }
    }
    ...
    public void doubleClick(String elementLocator, String elementName, String... formatArgs) {
        if (getElement(formatLocator(elementLocator, formatArgs))!= null) {
            ...
            Reporter.log(LogLevel.ERROR,elementName + " Element could not be Clicked");
            Reporter.addScreenshot("Element Not Clicked","Not Clicked");
            testContext.getLogger().log(LogLevel.ERROR, String.format(errorMessage,"double click"));
        }
    }
    ...
    public String getAttribute(String attributeName, String elementLocator, String elementName, String... formatters) {
        if (getElement(formatLocator(elementLocator, formatters)) != null) {
            ...
            Reporter.log(LogLevel.INFO,attributeName +" attribute for the element "+elementName+" has been retrieved with value "+attributeValue);
            return attributeValue;
        } else {
            Reporter.log(LogLevel.ERROR,attributeName +" attribute for teh element "+elementName+" could not be retrieved");
            Reporter.addScreenshot("ElementNotClicked","Not Clicked");
            testContext.getLogger().log(LogLevel.ERROR, String.format(errorMessage,"get attribute {"+ attributeName +"}"));
            return null;
        }
    }
    ...
    public void setText(String value, String elementLocator, String elementName, String... formatters) {
        if (getElement(formatLocator(elementLocator, formatters)) != null) {
            ...
            testContext.getLogger().log(LogLevel.ERROR, String.format(errorMessage,"set test {"+ value +"}"));
        }
    }
    ...
    public String getButtonText(String elementLocator, String elementName, String... formatters) {
        if (getElement(formatLocator(elementLocator, formatters)) != null) {
            ...
            return getAttribute(attributeValue, elementLocator, elementName,formatters);
        } else {
    ...
    public String getText(String elementLocator, String elementName, String... formatters) {
        if (getElement(formatLocator(elementLocator, formatters)) != null) {
            ...
            Reporter.log(LogLevel.INFO,"Text for the element "+elementName+" has been retrieved with value "+elementText);
            return elementText;
        } else {
    ...
    public String getCssValue(String elementLocator,String propertyName,String  elementName,String ... formatArgs) {
        if (getElement(formatLocator(elementLocator, formatArgs)) != null){
            ...
            Reporter.log(LogLevel.INFO,"CSS property "+propertyName+" for the element "+elementName+" has been retrieved with value "+cssValue);
        } else {
    ...
    public void verifyElementValue(String expectedValue, String elementLocator, String elementName, String... formatters) {
        if (getElement(formatLocator(elementLocator, formatters))!= null) {
            String actualValue = getAttribute( attributeValue, elementLocator, elementName,formatters);
    ...
    public void verifyElementAttribute(String errMsg, String elementLocator, String attributeName, String expValue,String elementName, String... formatters) {
        ...
        Reporter.log(LogLevel.INFO,"Expected Attribute "+attributeName+" value "+expValue+"has been matched with actual value "+actualValue+" for the element "+elementName);
    }

    public void verifyElementValue(String errMsg, String elementLocator,  String expValue,String elementName, String... formatters) {
        String actualValue= getElement(formatLocator(elementLocator, formatters)).getAttribute(attributeValue);
        Assertions.assertThat(actualValue).withFailMessage(() -> errMsg).isEqualTo(expValue);
        Reporter.log(LogLevel.INFO,"Expected value"+expValue+"has been matched with actual value "+actualValue+" for the element "+elementName);
    }
    ...
    public void verifyDropdownValues(String errMsg, List<String> expValues,String elementLocator,String elementName, String... formatters)
    {
        ...
        Reporter.log(LogLevel.INFO,"Expected options"+expValues+"has been matched with actual value "+optionsList+" for the element "+elementName);
    }
    ...
    public void selectRadioButtonUsingList(String value, String radioButtonSelector, String elementName, String... formatters) {
        ...
        for (WebElement element : webElements) {
            String radioButtonText = element.getAttribute(attributeValue);
